...
if __name__ == "__main__":
    dataset = pd.read_csv("./data/Machine Learning A-Z Chinese Template Folder/Part 3 - Classification/Section 13 - Naive Bayes/Social_Network_Ads.csv")
    print(dataset.info())
